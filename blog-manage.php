            ...
            <div class="card-body">
              ...
              <div class="row mb-3">
                ...
                <div class="row col-12">
                  <div class="col-6">
                    <a href="blog-add.php"><button class="btn btn-dark"><i class="ri-add-fill me-1"></i>Write a new blog</button></a>
                  </div>
                  <div class="col-6 d-flex justify-content-end">
                    <a href='blog-print.php?sql=<?= $a ?>'><button class="btn btn-info"><i class="bx bxs-report me-1"></i> Print</button></a>
                  </div>
                </div>
                  ...
                  <tbody>
                    ...
                    <?php while ($row = $result_article->fetch_assoc()) { ?>
                      ...
                      <th scope="row"><?= $nomor ?></th>
                                            ...
                                            <td><?= $row['category'] ?></td>
                        <td>
                          <a href="edit-blog-form.php?id='<?= $row["id"] ?>'"><button class="btn btn-outline-info alert-delete-confirm"><i class="ri-edit-2-fill"></i></button></a>
                          <a href="logics/delete-blog.php?id='<?= $row["id"] ?>'"><button class="btn btn-outline-danger alert-delete-confirm"><i class="ri-delete-bin-2-fill"></i></button></a>
